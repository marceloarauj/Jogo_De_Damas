...
public class VisaoMultiplayer extends Visao{
   ...
   //--------------------VARIAVEIS COMUNS-----------------------------------------------------------
    ...
    // retangulos float da vitoria ou derrota
    ...
    public void setup() {
        ...
        procurando = novaImagem.retorneImagem(R.drawable.procurandopartida);
        ...
        procurandoPartida.set(centro.x-105,
                              centro.y-60,
                             centro.x+105,
                           centro.y+60);
        ...
        vit = getNovaImagem().retorneImagem(R.drawable.avisodevitoria);
        derrt = getNovaImagem().retorneImagem(R.drawable.avisodederrota);
    ...
    public void update(Canvas canvas) {
        ...
        Desenhar desenhar = this.getNovoDesenho();
        ...
        if(!iniciarJogo) {
            ...
            desenhar.desenharImagens(procurando,procurandoPartida,areaDeDesenho);
            ...
            if (selecionar == false) {
                ...
                if (peçaSelecionada.isRainha()) {
                    ...
                    if (comerPeca == true) {
                        ...
                        /*AlertDialog.Builder alerta = new AlertDialog.Builder(atv);
                        alerta.setMessage(""+passarVez);
                        alerta.create();
                        alerta.show();*/
